...
class UsuarioController
{
    ...
    public function actualizar($id, array $data)
    {
        ...
        if (!empty($data['Password_Usuario'])) {
            ...
            // Si viene vacío, lo quitamos para no sobrescribir con string vacío
    ...
    public function login($NombreUsuario, $Contraseña)
    {
        ...
        if (empty($NombreUsuario))
            throw new \InvalidArgumentException('Nombre requerido');
        if (empty($Contraseña))
            throw new \InvalidArgumentException('Contrasena requerido');
        ...
        if ($usuarios && count($usuarios) > 0) {
            ...
            throw new \InvalidArgumentException('Nombre de usuario no registrado');
        }
