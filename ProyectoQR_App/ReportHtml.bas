...
Sub Process_Globals
	Public ReportJson As String ' asignado por ReportsByArea antes de StartActivity
End Sub
...
Sub RenderReport(rp As Map)
	...
	If rp.ContainsKey("car_reports") Then
		...
		End Try
	Else
		' si no hay car_reports mostrar raw si existe
	...
	' Ajustar contenido del panel del Scroll
	pnl.Height = y + 20dip
End Sub
