...
int _i = 0;
String _ch = "";
 //BA.debugLineNum = 391;BA.debugLine="Sub ExtractFirstJson(s As String) As String";
 //BA.debugLineNum = 392;BA.debugLine="If s = Null Then Return \"\"";
if (_s== null) { 
if (true) return "";};
 //BA.debugLineNum = 393;BA.debugLine="s = s.Trim";
_s = _s.trim();
 //BA.debugLineNum = 394;BA.debugLine="Dim len As Int = s.Length";
_len = _s.length();
 //BA.debugLineNum = 395;BA.debugLine="If len = 0 Then Return \"\"";
if (_len==0) { 
if (true) return "";};
 //BA.debugLineNum = 398;BA.debugLine="Dim firstObj As Int = s.IndexOf(\"{\")";
_firstobj = _s.indexOf("{");
 //BA.debugLineNum = 399;BA.debugLine="Dim firstArr As Int = s.IndexOf(\"[\")";
_firstarr = _s.indexOf("[");
 //BA.debugLineNum = 400;BA.debugLine="Dim start As Int";
_start = 0;
 //BA.debugLineNum = 401;BA.debugLine="If firstObj = -1 And firstArr = -1 Then Return \"\"";
if (_firstobj==-1 && _firstarr==-1) { 
if (true) return "";};
 //BA.debugLineNum = 402;BA.debugLine="If firstObj = -1 Then";
if (_firstobj==-1) { 
 //BA.debugLineNum = 403;BA.debugLine="start = firstArr";
_start = _firstarr;
 }else if(_firstarr==-1) { 
 //BA.debugLineNum = 405;BA.debugLine="start = firstObj";
_start = _firstobj;
 }else {
 //BA.debugLineNum = 407;BA.debugLine="If firstObj < firstArr Then";
if (_firstobj<_firstarr) { 
 //BA.debugLineNum = 408;BA.debugLine="start = firstObj";
_start = _firstobj;
 }else {
 //BA.debugLineNum = 410;BA.debugLine="start = firstArr";
_start = _firstarr;
 };
 };
 //BA.debugLineNum = 414;BA.debugLine="Dim depth As Int = 0";
_depth = (int) (0);
 //BA.debugLineNum = 415;BA.debugLine="Dim inString As Boolean = False";
_instring = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 416;BA.debugLine="Dim escaped As Boolean = False";
_escaped = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 418;BA.debugLine="For i = start To len - 1";
{
final int step23 = 1;
final int limit23 = (int) (_len-1);
_i = _start ;
for (;_i <= limit23 ;_i = _i + step23 ) {
 //BA.debugLineNum = 419;BA.debugLine="Dim ch As String = s.SubString2(i, i + 1)";
_ch = _s.substring(_i,(int) (_i+1));
 //BA.debugLineNum = 420;BA.debugLine="If escaped Then";
if (_escaped) { 
 //BA.debugLineNum = 421;BA.debugLine="escaped = False";
_escaped = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 422;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 424;BA.debugLine="If ch = \"\\\" Then";
if ((_ch).equals("\\")) { 
 //BA.debugLineNum = 425;BA.debugLine="escaped = True";
_escaped = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 426;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 428;BA.debugLine="If ch = \"\"\"\" Then";
if ((_ch).equals("\"")) { 
 //BA.debugLineNum = 429;BA.debugLine="inString = Not(inString)";
_instring = anywheresoftware.b4a.keywords.Common.Not(_instring);
 //BA.debugLineNum = 430;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 433;BA.debugLine="If Not(inString) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_instring)) { 
 //BA.debugLineNum = 434;BA.debugLine="If ch = \"{\" Or ch = \"[\" Then";
if ((_ch).equals("{") || (_ch).equals("[")) { 
 //BA.debugLineNum = 435;BA.debugLine="depth = depth + 1";
_depth = (int) (_depth+1);
 }else if((_ch).equals("}") || (_ch).equals("]")) { 
 //BA.debugLineNum = 437;BA.debugLine="depth = depth - 1";
_depth = (int) (_depth-1);
 //BA.debugLineNum = 438;BA.debugLine="If depth = 0 Then";
if (_depth==0) { 
 //BA.debugLineNum = 440;BA.debugLine="Return s.SubString2(start, i + 1)";
if (true) return _s.substring(_start,(int) (_i+1));
 ...
 //BA.debugLineNum = 446;BA.debugLine="Return \"\" ' no se encontró un bloque completo";
if (true) return "";
...
_url = _url+"?area="+_areacode;
 ...
 //BA.debugLineNum = 85;BA.debugLine="ProgressDialogShow(\"Cargando reportes...\")";
...
_j = new b4a.example.httpjob();
 //BA.debugLineNum = 87;BA.debugLine="j.Initialize(\"getReports\", Me)";
_j._initialize /*String*/ (processBA,"getReports",reportsbyarea.getObject());
 //BA.debugLineNum = 88;BA.debugLine="j.Download(url)";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 96;BA.debugLine="If Job.Success = False Then";
if (_job._success /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 97;BA.debugLine="ToastMessageShow(\"Error al obtener reportes: \" &";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Error al obtener reportes: "+_job._errormessage /*String*/ ),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 98;BA.debugLine="Log(\"JobDone: HTTP error: \" & Job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.LogImpl("31900548","JobDone: HTTP error: "+_job._errormessage /*String*/ ,0);
 //BA.debugLineNum = 99;BA.debugLine="Job.Release";
_job._release /*String*/ ();
 //BA.debugLineNum = 100;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 103;BA.debugLine="Dim res As String = Job.GetString";
_res = _job._getstring /*String*/ ();
 //BA.debugLineNum = 104;BA.debugLine="If res = Null Then res = \"\"";
if (_res== null) { 
_res = "";};
 //BA.debugLineNum = 106;BA.debugLine="Try";
try { //BA.debugLineNum = 107;BA.debugLine="res = res.Replace(Chr(65279), \"\")";
_res = _res.replace(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (65279))),"");
 } 
       catch (Exception e13) {
			processBA.setLastException(e13); //BA.debugLineNum = 109;BA.debugLine="Log(\"BOM replace error: \" & LastException.Messag";
anywheresoftware.b4a.keywords.Common.LogImpl("31900559","BOM replace error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 111;BA.debugLine="res = res.Trim";
_res = _res.trim();
 //BA.debugLineNum = 113;BA.debugLine="If res = \"\" Then";
if ((_res).equals("")) { 
 //BA.debugLineNum = 114;BA.debugLine="ToastMessageShow(\"Respuesta vacía del servidor.\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Respuesta vacía del servidor."),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 115;BA.debugLine="Log(\"JobDone: empty response\")";
anywheresoftware.b4a.keywords.Common.LogImpl("31900565","JobDone: empty response",0);
...
try { //BA.debugLineNum = 122;BA.debugLine="File.WriteString(File.DirInternal, \"reports_resp";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"reports_response_debug.json",_res);
 //BA.debugLineNum = 123;BA.debugLine="Log(\"Saved raw response to: \" & File.Combine(Fil";
anywheresoftware.b4a.keywords.Common.LogImpl("31900573","Saved raw response to: "+anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"reports_response_debug.json"),0);
 } 
       catch (Exception e26) {
			processBA.setLastException(e26); //BA.debugLineNum = 125;BA.debugLine="Log(\"Error writing debug file: \" & LastException";
anywheresoftware.b4a.keywords.Common.LogImpl("31900575","Error writing debug file: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 129;BA.debugLine="Dim extracted As String = ExtractFirstJson(res)";
_extracted = _extractfirstjson(_res);
 //BA.debugLineNum = 130;BA.debugLine="If extracted = \"\" Then";
if ((_extracted).equals("")) { 
 //BA.debugLineNum = 131;BA.debugLine="Log(\"ExtractFirstJson returned empty. Response m";
anywheresoftware.b4a.keywords.Common.LogImpl("31900581","ExtractFirstJson returned empty. Response may be malformed. Response snippet: "+_res.substring((int) (0),(int) (anywheresoftware.b4a.keywords.Common.Min(_res.length(),1000))),0);
 //BA.debugLineNum = 132;BA.debugLine="ToastMessageShow(\"No se detectó un bloque JSON c";
...
try { //BA.debugLineNum = 139;BA.debugLine="File.WriteString(File.DirInternal, \"reports_resp";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"reports_response_extracted.json",_extracted);
 //BA.debugLineNum = 140;BA.debugLine="Log(\"Saved extracted JSON to: \" & File.Combine(F";
anywheresoftware.b4a.keywords.Common.LogImpl("31900590","Saved extracted JSON to: "+anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"reports_response_extracted.json"),0);
 } 
       catch (Exception e39) {
			processBA.setLastException(e39); //BA.debugLineNum = 142;BA.debugLine="Log(\"Error writing extracted debug file: \" & Las";
anywheresoftware.b4a.keywords.Common.LogImpl("31900592","Error writing extracted debug file: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 146;BA.debugLine="Dim sb As StringBuilder";
_sb = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 147;BA.debugLine="sb.Initialize";
_sb.Initialize();
 //BA.debugLineNum = 148;BA.debugLine="For i = 0 To extracted.Length - 1";
{
final int step43 = 1;
final int limit43 = (int) (_extracted.length()-1);
_i = (int) (0) ;
for (;_i <= limit43 ;_i = _i + step43 ) {
 //BA.debugLineNum = 149;BA.debugLine="Dim ch As String = extracted.SubString2(i, i + 1";
_ch = _extracted.substring(_i,(int) (_i+1));
 //BA.debugLineNum = 150;BA.debugLine="Dim b() As Byte = ch.GetBytes(\"UTF8\")";
_b = _ch.getBytes("UTF8");
 //BA.debugLineNum = 151;BA.debugLine="Dim code As Int = 32";
_code = (int) (32);
 //BA.debugLineNum = 152;BA.debugLine="If b.Length > 0 Then";
if (_b.length>0) { 
 //BA.debugLineNum = 153;BA.debugLine="code = b(0)";
_code = (int) (_b[(int) (0)]);
 //BA.debugLineNum = 154;BA.debugLine="If code < 0 Then code = code + 256";
if (_code<0) { 
_code = (int) (_code+256);};
 };
 //BA.debugLineNum = 156;BA.debugLine="If code >= 32 Or code = 9 Or code = 10 Or code =";
if (_code>=32 || _code==9 || _code==10 || _code==13) { 
 //BA.debugLineNum = 157;BA.debugLine="sb.Append(ch)";
_sb.Append(_ch);
 }else {
 };
 }
};
 //BA.debugLineNum = 162;BA.debugLine="Dim cleaned As String = sb.ToString";
_cleaned = _sb.ToString();
 //BA.debugLineNum = 164;BA.debugLine="If cleaned <> extracted Then";
if ((_cleaned).equals(_extracted) == false) { 
 //BA.debugLineNum = 165;BA.debugLine="Log(\"EXTRACTED cleaned: length from \" & extracte";
anywheresoftware.b4a.keywords.Common.LogImpl("31900615","EXTRACTED cleaned: length from "+BA.NumberToString(_extracted.length())+" -> "+BA.NumberToString(_cleaned.length()),0);
 };
 //BA.debugLineNum = 169;BA.debugLine="Try";
try { //BA.debugLineNum = 170;BA.debugLine="File.WriteString(File.DirInternal, \"reports_resp";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"reports_response_cleaned.json",_cleaned);
 //BA.debugLineNum = 171;BA.debugLine="Log(\"Saved cleaned JSON to: \" & File.Combine(Fil";
anywheresoftware.b4a.keywords.Common.LogImpl("31900621","Saved cleaned JSON to: "+anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"reports_response_cleaned.json"),0);
 } 
       catch (Exception e64) {
			processBA.setLastException(e64); //BA.debugLineNum = 173;BA.debugLine="Log(\"Could not write cleaned JSON file: \" & Last";
anywheresoftware.b4a.keywords.Common.LogImpl("31900623","Could not write cleaned JSON file: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 179;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 180;BA.debugLine="Dim root As Object";
_root = new Object();
 //BA.debugLineNum = 181;BA.debugLine="Try";
try { //BA.debugLineNum = 182;BA.debugLine="parser.Initialize(cleaned)";
_parser.Initialize(_cleaned);
 //BA.debugLineNum = 183;BA.debugLine="If cleaned.StartsWith(\"{\") Then";
if (_cleaned.startsWith("{")) { 
 //BA.debugLineNum = 184;BA.debugLine="Try";
try { //BA.debugLineNum = 185;BA.debugLine="root = parser.NextObject";
_root = (Object)(_parser.NextObject().getObject());
 //BA.debugLineNum = 186;BA.debugLine="Log(\"Parsed cleaned as JSON Object\")";
anywheresoftware.b4a.keywords.Common.LogImpl("31900636","Parsed cleaned as JSON Object",0);
 } 
       catch (Exception e75) {
			processBA.setLastException(e75); //BA.debugLineNum = 188;BA.debugLine="Log(\"Parser NextObject failed: \" & LastExcepti";
anywheresoftware.b4a.keywords.Common.LogImpl("31900638","Parser NextObject failed: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 //BA.debugLineNum = 189;BA.debugLine="root = Null";
_root = anywheresoftware.b4a.keywords.Common.Null;
 };
 }else if(_cleaned.startsWith("[")) { 
 //BA.debugLineNum = 192;BA.debugLine="Try";
try { //BA.debugLineNum = 193;BA.debugLine="root = parser.NextArray";
_root = (Object)(_parser.NextArray().getObject());
 //BA.debugLineNum = 194;BA.debugLine="Log(\"Parsed cleaned as JSON Array\")";
anywheresoftware.b4a.keywords.Common.LogImpl("31900644","Parsed cleaned as JSON Array",0);
 } 
       catch (Exception e83) {
			processBA.setLastException(e83); //BA.debugLineNum = 196;BA.debugLine="Log(\"Parser NextArray failed: \" & LastExceptio";
anywheresoftware.b4a.keywords.Common.LogImpl("31900646","Parser NextArray failed: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 //BA.debugLineNum = 197;BA.debugLine="root = Null";
_root = anywheresoftware.b4a.keywords.Common.Null;
 };
 }else {
 //BA.debugLineNum = 200;BA.debugLine="Log(\"Cleaned does not start with { or [, cannot";
anywheresoftware.b4a.keywords.Common.LogImpl("31900650","Cleaned does not start with { or [, cannot parse.",0);
 //BA.debugLineNum = 201;BA.debugLine="root = Null";
_root = anywheresoftware.b4a.keywords.Common.Null;
 };
 } 
       catch (Exception e91) {
			processBA.setLastException(e91); //BA.debugLineNum = 204;BA.debugLine="Log(\"Parser initialize error: \" & LastException.";
anywheresoftware.b4a.keywords.Common.LogImpl("31900654","Parser initialize error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 //BA.debugLineNum = 205;BA.debugLine="root = Null";
_root = anywheresoftware.b4a.keywords.Common.Null;
 };
 //BA.debugLineNum = 208;BA.debugLine="If root = Null Then";
if (_root== null) { 
 //BA.debugLineNum = 209;BA.debugLine="Try";
try { //BA.debugLineNum = 210;BA.debugLine="Dim snippet As String = cleaned";
_snippet = _cleaned;
 //BA.debugLineNum = 211;BA.debugLine="If snippet.Length > 2000 Then snippet = snippet";
if (_snippet.length()>2000) { 
_snippet = _snippet.substring((int) (0),(int) (2000));};
 //BA.debugLineNum = 212;BA.debugLine="Log(\"FINAL_PARSE_FAILED_SNIPPET: \" & snippet)";
anywheresoftware.b4a.keywords.Common.LogImpl("31900662","FINAL_PARSE_FAILED_SNIPPET: "+_snippet,0);
 } 
       catch (Exception e100) {
			processBA.setLastException(e100); //BA.debugLineNum = 214;BA.debugLine="Log(\"Could not produce FINAL_PARSE_FAILED_SNIPP";
anywheresoftware.b4a.keywords.Common.LogImpl("31900664","Could not produce FINAL_PARSE_FAILED_SNIPPET",0);
 };
 //BA.debugLineNum = 216;BA.debugLine="ToastMessageShow(\"No se pudo parsear la respuest";
...
if (true) return "";
 ...
 //BA.debugLineNum = 222;BA.debugLine="Dim list As List";
_list = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 223;BA.debugLine="list.Initialize";
_list.Initialize();
 //BA.debugLineNum = 225;BA.debugLine="Try";
try { //BA.debugLineNum = 226;BA.debugLine="If root Is List Then";
if (_root instanceof java.util.List) { 
 //BA.debugLineNum = 227;BA.debugLine="list = root";
_list = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_root));
 ...
 //BA.debugLineNum = 229;BA.debugLine="Dim mp As Map = root";
...
_mp = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_root));
 //BA.debugLineNum = 230;BA.debugLine="If mp.ContainsKey(\"data\") And mp.Get(\"data\") Is";
if (_mp.ContainsKey((Object)("data")) && _mp.Get((Object)("data")) instanceof java.util.List) { 
 //BA.debugLineNum = 231;BA.debugLine="list = mp.Get(\"data\")";
_list = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_mp.Get((Object)("data"))));
 ...
 //BA.debugLineNum = 233;BA.debugLine="list = mp.Get(\"reportes\")";
_list = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_mp.Get((Object)("reportes"))));
 ...
 //BA.debugLineNum = 236;BA.debugLine="For Each k As String In mp.Keys";
{
...
_k = BA.ObjectToString(group118.Get(index118));
 //BA.debugLineNum = 237;BA.debugLine="Dim v As Object = mp.Get(k)";
_v = _mp.Get((Object)(_k));
 //BA.debugLineNum = 238;BA.debugLine="If v Is List Then";
if (_v instanceof java.util.List) { 
 //BA.debugLineNum = 239;BA.debugLine="list = v";
_list = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_v));
 //BA.debugLineNum = 240;BA.debugLine="Exit";
if (true) break;
 };
 }
};
 //BA.debugLineNum = 245;BA.debugLine="If (list.IsInitialized = False Or list.Size =";
if ((_list.IsInitialized()==anywheresoftware.b4a.keywords.Common.False || _list.getSize()==0)) { 
 //BA.debugLineNum = 246;BA.debugLine="If mp.ContainsKey(\"area\") Or mp.ContainsKey(\"";
if (_mp.ContainsKey((Object)("area")) || _mp.ContainsKey((Object)("car_reports")) || _mp.ContainsKey((Object)("JSON_Reporte"))) { 
 //BA.debugLineNum = 247;BA.debugLine="list.Initialize";
_list.Initialize();
 //BA.debugLineNum = 248;BA.debugLine="list.Add(mp)";
_list.Add((Object)(_mp.getObject()));
			...
			processBA.setLastException(e134); //BA.debugLineNum = 254;BA.debugLine="Log(\"JobDone building list error: \" & LastExcept";
anywheresoftware.b4a.keywords.Common.LogImpl("31900704","JobDone building list error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 //BA.debugLineNum = 255;BA.debugLine="ToastMessageShow(\"Error procesando estructura de";
...
if (true) return "";
 ...
 //BA.debugLineNum = 261;BA.debugLine="reportsMap.Clear";
mostCurrent._reportsmap.Clear();
 //BA.debugLineNum = 262;BA.debugLine="lv.Clear";
mostCurrent._lv.Clear();
 //BA.debugLineNum = 264;BA.debugLine="For i = 0 To list.Size - 1";
{
final int step141 = 1;
final int limit141 = (int) (_list.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit141 ;_i = _i + step141 ) {
 //BA.debugLineNum = 265;BA.debugLine="Dim rawItem As Object = list.Get(i)";
_rawitem = _list.Get(_i);
 //BA.debugLineNum = 266;BA.debugLine="Dim reportContent As Map";
_reportcontent = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 267;BA.debugLine="reportContent = Null";
_reportcontent = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 270;BA.debugLine="Dim dateStr As String = \"\"";
_datestr = "";
 //BA.debugLineNum = 271;BA.debugLine="If rawItem Is Map Then";
if (_rawitem instanceof java.util.Map) { 
 //BA.debugLineNum = 272;BA.debugLine="Dim rm As Map = rawItem";
...
_rm = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_rawitem));
 //BA.debugLineNum = 273;BA.debugLine="If rm.ContainsKey(\"FechaRegistro_Reporte\") Then";
if (_rm.ContainsKey((Object)("FechaRegistro_Reporte"))) { 
_datestr = BA.ObjectToString(_rm.Get((Object)("FechaRegistro_Reporte")));};
 //BA.debugLineNum = 274;BA.debugLine="If dateStr = \"\" And rm.ContainsKey(\"created_at\"";
...
if (_rawitem instanceof java.util.Map) { 
 //BA.debugLineNum = 278;BA.debugLine="Dim candidate As Map = rawItem";
...
_candidate = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_rawitem));
 //BA.debugLineNum = 281;BA.debugLine="If candidate.ContainsKey(\"JSON_Reporte_parsed\")";
if (_candidate.ContainsKey((Object)("JSON_Reporte_parsed"))) { 
 //BA.debugLineNum = 282;BA.debugLine="Dim parsedObj As Object = candidate.Get(\"JSON_";
_parsedobj = _candidate.Get((Object)("JSON_Reporte_parsed"));
 //BA.debugLineNum = 283;BA.debugLine="If parsedObj Is Map Then";
if (_parsedobj instanceof java.util.Map) { 
 //BA.debugLineNum = 284;BA.debugLine="reportContent = parsedObj";
_reportcontent = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_parsedobj));
 ...
 //BA.debugLineNum = 286;BA.debugLine="Dim pl As List = parsedObj";
...
_pl = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_parsedobj));
 //BA.debugLineNum = 287;BA.debugLine="If pl.Size > 0 And pl.Get(0) Is Map Then repo";
...
_reportcontent = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_pl.Get((int) (0))));};
 ...
 //BA.debugLineNum = 292;BA.debugLine="If reportContent = Null And candidate.ContainsK";
if (_reportcontent== null && _candidate.ContainsKey((Object)("JSON_Reporte"))) { 
 //BA.debugLineNum = 293;BA.debugLine="Try";
try { //BA.debugLineNum = 294;BA.debugLine="Dim sjson As String = candidate.Get(\"JSON_Rep";
_sjson = BA.ObjectToString(_candidate.Get((Object)("JSON_Reporte")));
 //BA.debugLineNum = 295;BA.debugLine="If sjson <> \"\" Then";
if ((_sjson).equals("") == false) { 
 //BA.debugLineNum = 296;BA.debugLine="Dim p As JSONParser";
_p = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 297;BA.debugLine="p.Initialize(sjson)";
_p.Initialize(_sjson);
 //BA.debugLineNum = 298;BA.debugLine="Dim maybe As Object = p.NextValue";
_maybe = _p.NextValue();
 //BA.debugLineNum = 299;BA.debugLine="If maybe Is Map Then";
if (_maybe instanceof java.util.Map) { 
 //BA.debugLineNum = 300;BA.debugLine="reportContent = maybe";
_reportcontent = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_maybe));
 ...
 //BA.debugLineNum = 302;BA.debugLine="Dim ltmp As List = maybe";
...
_ltmp = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_maybe));
 //BA.debugLineNum = 303;BA.debugLine="If ltmp.Size > 0 And ltmp.Get(0) Is Map The";
...
_reportcontent = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_ltmp.Get((int) (0))));};
			...
			processBA.setLastException(e177); //BA.debugLineNum = 307;BA.debugLine="Log(\"Error parsing JSON_Reporte: \" & LastExce";
anywheresoftware.b4a.keywords.Common.LogImpl("31900757","Error parsing JSON_Reporte: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 //BA.debugLineNum = 312;BA.debugLine="If reportContent = Null Then";
if (_reportcontent== null) { 
 //BA.debugLineNum = 313;BA.debugLine="If candidate.ContainsKey(\"area\") Or candidate.";
if (_candidate.ContainsKey((Object)("area")) || _candidate.ContainsKey((Object)("car_reports"))) { 
 //BA.debugLineNum = 314;BA.debugLine="reportContent = candidate";
_reportcontent = _candidate;
 };
 };
 }else {
 //BA.debugLineNum = 319;BA.debugLine="Try";
try { //BA.debugLineNum = 320;BA.debugLine="Dim s2 As String = rawItem";
_s2 = BA.ObjectToString(_rawitem);
 //BA.debugLineNum = 321;BA.debugLine="Dim p3 As JSONParser";
_p3 = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 322;BA.debugLine="p3.Initialize(s2)";
_p3.Initialize(_s2);
 //BA.debugLineNum = 323;BA.debugLine="Dim maybe2 As Object = p3.NextValue";
_maybe2 = _p3.NextValue();
 //BA.debugLineNum = 324;BA.debugLine="If maybe2 Is Map Then";
if (_maybe2 instanceof java.util.Map) { 
 //BA.debugLineNum = 325;BA.debugLine="reportContent = maybe2";
_reportcontent = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_maybe2));
			...
			processBA.setLastException(e195); //BA.debugLineNum = 328;BA.debugLine="Log(\"Ignored non-map rawItem parse error: \" &";
anywheresoftware.b4a.keywords.Common.LogImpl("31900778","Ignored non-map rawItem parse error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 //BA.debugLineNum = 332;BA.debugLine="If reportContent = Null Then";
if (_reportcontent== null) { 
 //BA.debugLineNum = 333;BA.debugLine="reportContent.Initialize";
_reportcontent.Initialize();
 //BA.debugLineNum = 334;BA.debugLine="reportContent.Put(\"raw\", rawItem)";
_reportcontent.Put((Object)("raw"),_rawitem);
 };
 //BA.debugLineNum = 338;BA.debugLine="Dim title As String = \"\"";
_title = "";
 //BA.debugLineNum = 339;BA.debugLine="If reportContent.ContainsKey(\"area\") Then";
if (_reportcontent.ContainsKey((Object)("area"))) { 
 //BA.debugLineNum = 340;BA.debugLine="Try";
try { //BA.debugLineNum = 341;BA.debugLine="Dim areaMap As Map = reportContent.Get(\"area\")";
...
_areamap = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_reportcontent.Get((Object)("area"))));
 //BA.debugLineNum = 342;BA.debugLine="If areaMap.ContainsKey(\"area_name\") Then title";
if (_areamap.ContainsKey((Object)("area_name"))) { 
_title = BA.ObjectToString(_areamap.Get((Object)("area_name")));};
 //BA.debugLineNum = 343;BA.debugLine="If title = \"\" And areaMap.ContainsKey(\"areaNam";
...
_title = BA.ObjectToString(_areamap.Get((Object)("areaName")));};
			...
			processBA.setLastException(e209); //BA.debugLineNum = 345;BA.debugLine="Log(\"Error leyendo area_name: \" & LastExceptio";
anywheresoftware.b4a.keywords.Common.LogImpl("31900795","Error leyendo area_name: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 //BA.debugLineNum = 349;BA.debugLine="If title = \"\" Then";
if ((_title).equals("")) { 
 //BA.debugLineNum = 350;BA.debugLine="If reportContent.ContainsKey(\"Id_Reporte\") Then";
if (_reportcontent.ContainsKey((Object)("Id_Reporte"))) { 
 //BA.debugLineNum = 351;BA.debugLine="title = \"Reporte \" & reportContent.Get(\"Id_Rep";
_title = "Reporte "+BA.ObjectToString(_reportcontent.Get((Object)("Id_Reporte")));
 }else {
 //BA.debugLineNum = 353;BA.debugLine="If reportContent.ContainsKey(\"id\") Then";
if (_reportcontent.ContainsKey((Object)("id"))) { 
 //BA.debugLineNum = 354;BA.debugLine="title = \"Reporte \" & reportContent.Get(\"id\")";
_title = "Reporte "+BA.ObjectToString(_reportcontent.Get((Object)("id")));
 }else {
 //BA.debugLineNum = 356;BA.debugLine="title = \"Reporte \" & (i + 1)";
_title = "Reporte "+BA.NumberToString((_i+1));
 };
 };
 };
 //BA.debugLineNum = 362;BA.debugLine="If dateStr <> \"\" Then";
if ((_datestr).equals("") == false) { 
 //BA.debugLineNum = 363;BA.debugLine="title = dateStr & \" - \" & title";
_title = _datestr+" - "+_title;
 };
 //BA.debugLineNum = 366;BA.debugLine="lv.AddSingleLine2(title, i)";
mostCurrent._lv.AddSingleLine2(BA.ObjectToCharSequence(_title),(Object)(_i));
 //BA.debugLineNum = 369;BA.debugLine="Dim stored As Map";
_stored = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 370;BA.debugLine="stored.Initialize";
_stored.Initialize();
 //BA.debugLineNum = 371;BA.debugLine="stored.Put(\"parsed\", reportContent) ' Map (puede";
_stored.Put((Object)("parsed"),(Object)(_reportcontent.getObject()));
 //BA.debugLineNum = 372;BA.debugLine="If rawItem Is Map Then";
if (_rawitem instanceof java.util.Map) { 
 //BA.debugLineNum = 373;BA.debugLine="stored.Put(\"raw\", rawItem) ' fila original devu";
_stored.Put((Object)("raw"),_rawitem);
 }else {
 //BA.debugLineNum = 375;BA.debugLine="stored.Put(\"raw\", Null)";
_stored.Put((Object)("raw"),anywheresoftware.b4a.keywords.Common.Null);
 };
 //BA.debugLineNum = 377;BA.debugLine="reportsMap.Put(i, stored)";
mostCurrent._reportsmap.Put((Object)(_i),(Object)(_stored.getObject()));
 }
};
 //BA.debugLineNum = 381;BA.debugLine="If lv.Size = 0 Then ToastMessageShow(\"No se encon";
...
String _jsonstr = "";
 //BA.debugLineNum = 453;BA.debugLine="Sub lvReports_ItemClick (Position As Int, Value As";
 //BA.debugLineNum = 454;BA.debugLine="Dim idx As Int = Value";
_idx = (int)(BA.ObjectToNumber(_value));
 //BA.debugLineNum = 455;BA.debugLine="Log(\"lvReports_ItemClick fired. idx=\" & idx)";
anywheresoftware.b4a.keywords.Common.LogImpl("32031618","lvReports_ItemClick fired. idx="+BA.NumberToString(_idx),0);
 //BA.debugLineNum = 456;BA.debugLine="ToastMessageShow(\"Click: \" & idx, False) ' confir";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Click: "+BA.NumberToString(_idx)),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 458;BA.debugLine="If reportsMap.IsInitialized = False Then";
if (mostCurrent._reportsmap.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 459;BA.debugLine="Log(\"lvReports_ItemClick: reportsMap no iniciali";
anywheresoftware.b4a.keywords.Common.LogImpl("32031622","lvReports_ItemClick: reportsMap no inicializado",0);
 //BA.debugLineNum = 460;BA.debugLine="MsgboxAsync(\"Mapa de reportes no inicializado\",";
...
if (true) return "";
 ...
 //BA.debugLineNum = 464;BA.debugLine="If reportsMap.ContainsKey(idx) = False Then";
if (mostCurrent._reportsmap.ContainsKey((Object)(_idx))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 465;BA.debugLine="Log(\"lvReports_ItemClick: reportsMap no contiene";
anywheresoftware.b4a.keywords.Common.LogImpl("32031628","lvReports_ItemClick: reportsMap no contiene idx="+BA.NumberToString(_idx),0);
 //BA.debugLineNum = 466;BA.debugLine="MsgboxAsync(\"Reporte no encontrado\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 470;BA.debugLine="Dim stored As Map";
_stored = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 471;BA.debugLine="stored = Null";
...
try { //BA.debugLineNum = 473;BA.debugLine="stored = reportsMap.Get(idx)";
_stored = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(mostCurrent._reportsmap.Get((Object)(_idx))));
			...
			processBA.setLastException(e19); //BA.debugLineNum = 475;BA.debugLine="Log(\"lvReports_ItemClick: error al obtener store";
anywheresoftware.b4a.keywords.Common.LogImpl("32031638","lvReports_ItemClick: error al obtener stored: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 //BA.debugLineNum = 476;BA.debugLine="MsgboxAsync(\"Reporte inválido\", \"Error\")";
...
if (true) return "";
 ...
 //BA.debugLineNum = 480;BA.debugLine="If stored = Null Then";
if (_stored== null) { 
 //BA.debugLineNum = 481;BA.debugLine="Log(\"lvReports_ItemClick: stored es Null\")";
anywheresoftware.b4a.keywords.Common.LogImpl("32031644","lvReports_ItemClick: stored es Null",0);
 //BA.debugLineNum = 482;BA.debugLine="MsgboxAsync(\"Reporte inválido\", \"Error\")";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("Reporte inválido"),BA.ObjectToCharSequence("Error"),processBA);
 //BA.debugLineNum = 483;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 487;BA.debugLine="Dim parsed As Map = Null";
...
_parsed = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 488;BA.debugLine="Dim raw As Map = Null";
...
try { //BA.debugLineNum = 490;BA.debugLine="If stored.ContainsKey(\"parsed\") Then";
if (_stored.ContainsKey((Object)("parsed"))) { 
 //BA.debugLineNum = 491;BA.debugLine="Dim tmpParsed As Object = stored.Get(\"parsed\")";
_tmpparsed = _stored.Get((Object)("parsed"));
 //BA.debugLineNum = 492;BA.debugLine="If tmpParsed Is Map Then parsed = tmpParsed";
...
_parsed = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_tmpparsed));};
			...
			processBA.setLastException(e36); //BA.debugLineNum = 495;BA.debugLine="Log(\"lvReports_ItemClick: error leyendo parsed:";
anywheresoftware.b4a.keywords.Common.LogImpl("32031658","lvReports_ItemClick: error leyendo parsed: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 498;BA.debugLine="Try";
try { //BA.debugLineNum = 499;BA.debugLine="If stored.ContainsKey(\"raw\") Then";
if (_stored.ContainsKey((Object)("raw"))) { 
 //BA.debugLineNum = 500;BA.debugLine="Dim tmpRaw As Object = stored.Get(\"raw\")";
_tmpraw = _stored.Get((Object)("raw"));
 //BA.debugLineNum = 501;BA.debugLine="If tmpRaw Is Map Then raw = tmpRaw";
...
_raw = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_tmpraw));};
			...
			processBA.setLastException(e44); //BA.debugLineNum = 504;BA.debugLine="Log(\"lvReports_ItemClick: error leyendo raw: \" &";
anywheresoftware.b4a.keywords.Common.LogImpl("32031667","lvReports_ItemClick: error leyendo raw: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 508;BA.debugLine="If parsed = Null And raw Is Map Then parsed = raw";
if (_parsed== null && _raw.getObjectOrNull() instanceof java.util.Map) { 
_parsed = _raw;};
 //BA.debugLineNum = 510;BA.debugLine="If parsed = Null Then";
if (_parsed== null) { 
 //BA.debugLineNum = 511;BA.debugLine="Log(\"lvReports_ItemClick: no hay parsed ni raw ú";
anywheresoftware.b4a.keywords.Common.LogImpl("32031674","lvReports_ItemClick: no hay parsed ni raw útiles",0);
 //BA.debugLineNum = 512;BA.debugLine="MsgboxAsync(\"No hay datos válidos para este repo";
...
if (true) return "";
 ...
 //BA.debugLineNum = 517;BA.debugLine="Dim out As Map";
_out = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 518;BA.debugLine="out.Initialize";
_out.Initialize();
 //BA.debugLineNum = 520;BA.debugLine="Try";
try { //BA.debugLineNum = 521;BA.debugLine="If parsed.ContainsKey(\"area\") Then out.Put(\"area";
if (_parsed.ContainsKey((Object)("area"))) { 
_out.Put((Object)("area"),_parsed.Get((Object)("area")));};
 } 
       catch (Exception e57) {
			processBA.setLastException(e57); //BA.debugLineNum = 523;BA.debugLine="Log(\"lvReports_ItemClick: error copiando parsed.";
anywheresoftware.b4a.keywords.Common.LogImpl("32031686","lvReports_ItemClick: error copiando parsed.area: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 525;BA.debugLine="Try";
try { //BA.debugLineNum = 526;BA.debugLine="If parsed.ContainsKey(\"car_reports\") Then out.Pu";
if (_parsed.ContainsKey((Object)("car_reports"))) { 
_out.Put((Object)("car_reports"),_parsed.Get((Object)("car_reports")));};
 } 
       catch (Exception e62) {
			processBA.setLastException(e62); //BA.debugLineNum = 528;BA.debugLine="Log(\"lvReports_ItemClick: error copiando parsed.";
anywheresoftware.b4a.keywords.Common.LogImpl("32031691","lvReports_ItemClick: error copiando parsed.car_reports: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 //BA.debugLineNum = 531;BA.debugLine="If (out.ContainsKey(\"area\") = False Or out.Contai";
if ((_out.ContainsKey((Object)("area"))==anywheresoftware.b4a.keywords.Common.False || _out.ContainsKey((Object)("car_reports"))==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 532;BA.debugLine="If raw Is Map Then";
if (_raw.getObjectOrNull() instanceof java.util.Map) { 
 //BA.debugLineNum = 534;BA.debugLine="If raw.ContainsKey(\"JSON_Reporte_parsed\") Then";
if (_raw.ContainsKey((Object)("JSON_Reporte_parsed"))) { 
 //BA.debugLineNum = 535;BA.debugLine="Try";
try { //BA.debugLineNum = 536;BA.debugLine="Dim jrMap As Map = raw.Get(\"JSON_Reporte_pars";
...
_jrmap = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_raw.Get((Object)("JSON_Reporte_parsed"))));
 //BA.debugLineNum = 537;BA.debugLine="If jrMap <> Null Then";
if (_jrmap!= null) { 
 //BA.debugLineNum = 538;BA.debugLine="If out.ContainsKey(\"area\") = False And jrMap";
if (_out.ContainsKey((Object)("area"))==anywheresoftware.b4a.keywords.Common.False && _jrmap.ContainsKey((Object)("area"))) { 
 //BA.debugLineNum = 539;BA.debugLine="out.Put(\"area\", jrMap.Get(\"area\"))";
_out.Put((Object)("area"),_jrmap.Get((Object)("area")));
 };
 //BA.debugLineNum = 541;BA.debugLine="If out.ContainsKey(\"car_reports\") = False An";
if (_out.ContainsKey((Object)("car_reports"))==anywheresoftware.b4a.keywords.Common.False && _jrmap.ContainsKey((Object)("car_reports"))) { 
 //BA.debugLineNum = 542;BA.debugLine="out.Put(\"car_reports\", jrMap.Get(\"car_repor";
_out.Put((Object)("car_reports"),_jrmap.Get((Object)("car_reports")));
 };
 };
 } 
       catch (Exception e78) {
			processBA.setLastException(e78); //BA.debugLineNum = 546;BA.debugLine="Log(\"lvReports_ItemClick: raw.JSON_Reporte_pa";
anywheresoftware.b4a.keywords.Common.LogImpl("32031709","lvReports_ItemClick: raw.JSON_Reporte_parsed no es Map o error: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 //BA.debugLineNum = 551;BA.debugLine="If (out.ContainsKey(\"area\") = False Or out.Cont";
...
try { //BA.debugLineNum = 553;BA.debugLine="Dim s As String = raw.Get(\"JSON_Reporte\")";
_s = BA.ObjectToString(_raw.Get((Object)("JSON_Reporte")));
 //BA.debugLineNum = 554;BA.debugLine="If s <> \"\" Then";
if ((_s).equals("") == false) { 
 //BA.debugLineNum = 555;BA.debugLine="Dim p As JSONParser";
_p = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 556;BA.debugLine="p.Initialize(s)";
_p.Initialize(_s);
 //BA.debugLineNum = 557;BA.debugLine="Dim maybe As Object = p.NextValue";
_maybe = _p.NextValue();
 //BA.debugLineNum = 558;BA.debugLine="If maybe Is Map Then";
if (_maybe instanceof java.util.Map) { 
 //BA.debugLineNum = 559;BA.debugLine="Dim m As Map = maybe";
...
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_maybe));
 //BA.debugLineNum = 560;BA.debugLine="If out.ContainsKey(\"area\") = False And m.Co";
...
_out.Put((Object)("area"),_m.Get((Object)("area")));};
 //BA.debugLineNum = 561;BA.debugLine="If out.ContainsKey(\"car_reports\") = False A";
...
_out.Put((Object)("car_reports"),_m.Get((Object)("car_reports")));};
			...
			processBA.setLastException(e95); //BA.debugLineNum = 565;BA.debugLine="Log(\"lvReports_ItemClick: error parseando JSO";
anywheresoftware.b4a.keywords.Common.LogImpl("32031728","lvReports_ItemClick: error parseando JSON_Reporte: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 };
 };
 //BA.debugLineNum = 572;BA.debugLine="If raw Is Map Then";
if (_raw.getObjectOrNull() instanceof java.util.Map) { 
 //BA.debugLineNum = 573;BA.debugLine="Try";
try { //BA.debugLineNum = 574;BA.debugLine="For Each k As String In raw.Keys";
{
...
try { //BA.debugLineNum = 576;BA.debugLine="If out.ContainsKey(k) = False Then out.Put(k,";
if (_out.ContainsKey((Object)(_k))==anywheresoftware.b4a.keywords.Common.False) { 
_out.Put((Object)(_k),_raw.Get((Object)(_k)));};
 } 
       catch (Exception e106) {
			processBA.setLastException(e106); //BA.debugLineNum = 578;BA.debugLine="Log(\"lvReports_ItemClick: no pudo copiar key \"";
anywheresoftware.b4a.keywords.Common.LogImpl("32031741","lvReports_ItemClick: no pudo copiar key "+_k+": "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 }
};
 } 
       catch (Exception e110) {
			processBA.setLastException(e110); //BA.debugLineNum = 582;BA.debugLine="Log(\"lvReports_ItemClick: error iterando keys ra";
anywheresoftware.b4a.keywords.Common.LogImpl("32031745","lvReports_ItemClick: error iterando keys raw: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 //BA.debugLineNum = 588;BA.debugLine="If out.ContainsKey(\"Id_Reporte\") = False Then";
if (_out.ContainsKey((Object)("Id_Reporte"))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 589;BA.debugLine="If raw Is Map And raw.ContainsKey(\"Id_Reporte\")";
...
try { //BA.debugLineNum = 594;BA.debugLine="Dim gen As JSONGenerator";
_gen = new anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 595;BA.debugLine="gen.Initialize(out)";
_gen.Initialize(_out);
 //BA.debugLineNum = 596;BA.debugLine="Dim jsonStr As String = gen.ToString";
_jsonstr = _gen.ToString();
 //BA.debugLineNum = 597;BA.debugLine="File.WriteString(File.DirInternal, \"current_repo";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"current_report.json",_jsonstr);
 //BA.debugLineNum = 598;BA.debugLine="Log(\"lvReports_ItemClick: wrote current_report.j";
anywheresoftware.b4a.keywords.Common.LogImpl("32031761","lvReports_ItemClick: wrote current_report.json length="+BA.NumberToString(_jsonstr.length()),0);
 //BA.debugLineNum = 599;BA.debugLine="Log(\"lvReports_ItemClick snippet: \" & jsonStr.Su";
anywheresoftware.b4a.keywords.Common.LogImpl("32031762","lvReports_ItemClick snippet: "+_jsonstr.substring((int) (0),(int) (anywheresoftware.b4a.keywords.Common.Min(800,_jsonstr.length()))),0);
 } 
       catch (Exception e124) {
			processBA.setLastException(e124); //BA.debugLineNum = 601;BA.debugLine="Log(\"lvReports_ItemClick: Error writing current_";
anywheresoftware.b4a.keywords.Common.LogImpl("32031764","lvReports_ItemClick: Error writing current_report.json: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 //BA.debugLineNum = 602;BA.debugLine="MsgboxAsync(\"No se pudo preparar el detalle del";
...
if (true) return "";
 ...
 //BA.debugLineNum = 606;BA.debugLine="ReportDetail.AllowEdit = False";
mostCurrent._reportdetail._allowedit /*boolean*/  = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 607;BA.debugLine="StartActivity(ReportDetail)";
