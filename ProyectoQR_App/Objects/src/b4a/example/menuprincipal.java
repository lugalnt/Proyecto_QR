...
anywheresoftware.b4a.keywords.Common.LogImpl("51114118","Error guardando last_area.json desde BTN_IniciarReporte_Click: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("51179654","Respuesta API getArea: "+_res,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51179756","Error guardando last_area.json: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("51179770","Error parse JSON getArea: "+anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage(),0);
 };
 };
 }else {
