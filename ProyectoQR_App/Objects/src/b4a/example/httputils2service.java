...
anywheresoftware.b4a.keywords.Common.LogImpl("41310727",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("41310728","Switching to File.DirInternal",0);
