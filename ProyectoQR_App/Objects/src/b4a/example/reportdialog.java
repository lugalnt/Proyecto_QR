...
anywheresoftware.b4a.keywords.Common.LogImpl("72293764","Respuesta SendReport: "+_res,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228266","last_area.json raw: "+_rawa,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228304","No se pudo parsear JSON_Area interno.",0);
 };
 };
 };
 } 
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228309","Error parseando last_area.json",0);
 };
 }else {
 //BA.debugLineNum = 610;BA.debugLine="Log(\"last_area.json no encontrado\")";
anywheresoftware.b4a.keywords.Common.LogImpl("72228312","last_area.json no encontrado",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228319","Usando Starter.Id_Area como fallback: "+_idarea,0);
 } 
       catch (Exception e81) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228332","Starter.Id_Usuario: "+_idusuario,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228340","No se enviará payload. idArea='"+_idarea+"', idUsuario='"+_idusuario+"'",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("72228363","Payload a enviar: "+_jgtest.ToString(),0);
