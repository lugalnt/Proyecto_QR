...
anywheresoftware.b4a.keywords.Common.LogImpl("64521988","Respuesta SendReport: "+_res,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456490","last_area.json raw: "+_rawa,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456528","No se pudo parsear JSON_Area interno.",0);
 };
 };
 };
 } 
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456533","Error parseando last_area.json",0);
 };
 }else {
 //BA.debugLineNum = 610;BA.debugLine="Log(\"last_area.json no encontrado\")";
anywheresoftware.b4a.keywords.Common.LogImpl("64456536","last_area.json no encontrado",0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456543","Usando Starter.Id_Area como fallback: "+_idarea,0);
 } 
       catch (Exception e81) {
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456556","Starter.Id_Usuario: "+_idusuario,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456564","No se enviará payload. idArea='"+_idarea+"', idUsuario='"+_idusuario+"'",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("64456587","Payload a enviar: "+_jgtest.ToString(),0);
