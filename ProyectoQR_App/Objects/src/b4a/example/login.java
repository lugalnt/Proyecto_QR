...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Activity.LoadLayout(\"loginscreen\")";
...
public static String  _button_submit_click() throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Private Sub Button_Submit_Click";
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 12;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 16;BA.debugLine="Private Nombre_Usuario As EditText";
mostCurrent._nombre_usuario = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private Password_Usuario As EditText";
